...
save_pathes = ['output/fashion-mnist-lba-ldp-defense-simplenet.pickle',
               'output/cifar10-lba-ldp-defense-simplenet.pickle',
               'output/dogs-vs-cats-lba-ldp-defense-simplenet.pickle',
               'output/hist-lba-ldp-defense-simplenet.pickle',
               'output/intel-lba-ldp-defense-simplenet.pickle',
               'output/fruits-lba-ldp-defense-simplenet.pickle',
               'output/imagenet-lba-ldp-defense-simplenet.pickle',]
