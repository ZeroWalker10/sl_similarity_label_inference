...
skip_datasets = ['fashion-mnist', 
                 ...
                 '102flowers']
save_pathes = ['output/fashion-mnist-kl-defense-resnet50-smash.pickle',
               'output/cifar10-kl-defense-resnet50-smash.pickle',
               'output/dogs-vs-cats-kl-defense-resnet50-smash.pickle',
               'output/hist-kl-defense-resnet50-smash.pickle',
               'output/intel-kl-defense-resnet50-smash.pickle',
               'output/flowers-kl-defense-resnet50-smash.pickle',]
