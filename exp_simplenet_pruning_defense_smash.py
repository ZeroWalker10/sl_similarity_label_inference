...
save_pathes = ['output/fashion-mnist-smash-pruning-defense-simplenet.pickle',
               'output/cifar10-smash-pruning-defense-simplenet.pickle',
               'output/dogs-vs-cats-smash-pruning-defense-simplenet.pickle',
               'output/hist-smash-pruning-defense-simplenet.pickle',
               'output/intel-smash-pruning-defense-simplenet.pickle',
               'output/fruits-smash-pruning-defense-simplenet.pickle',
               'output/imagenet-smash-pruning-defense-simplenet.pickle',]
