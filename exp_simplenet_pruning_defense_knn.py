...
save_pathes = ['output/fashion-mnist-knn-pruning-defense-simplenet.pickle',
               'output/cifar10-knn-pruning-defense-simplenet.pickle',
               'output/dogs-vs-cats-knn-pruning-defense-simplenet.pickle',
               'output/hist-knn-pruning-defense-simplenet.pickle',
               'output/intel-knn-pruning-defense-simplenet.pickle',
               'output/fruits-knn-pruning-defense-simplenet.pickle',
               'output/imagenet-knn-pruning-defense-simplenet.pickle',]
