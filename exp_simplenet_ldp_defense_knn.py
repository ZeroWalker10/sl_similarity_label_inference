...
save_pathes = ['output/fashion-mnist-knn-ldp-defense-simplenet.pickle',
               'output/cifar10-knn-ldp-defense-simplenet.pickle',
               'output/dogs-vs-cats-knn-ldp-defense-simplenet.pickle',
               'output/hist-knn-ldp-defense-simplenet.pickle',
               'output/intel-knn-ldp-defense-simplenet.pickle',
               'output/fruits-knn-ldp-defense-simplenet.pickle',
               'output/imagenet-knn-ldp-defense-simplenet.pickle',]
