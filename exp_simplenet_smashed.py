...
save_pathes = ['output/fashion-mnist-smashed-attack-simplenet.pickle',
               'output/cifar10-smashed-attack-simplenet.pickle',
               'output/dogs-vs-cats-smashed-attack-simplenet.pickle',
               'output/hist-smashed-attack-simplenet.pickle',
               'output/intel-smashed-attack-simplenet.pickle',
               'output/fruits-smashed-attack-simplenet.pickle',
               'output/imagenet-smashed-attack-simplenet.pickle',]
