...
from .role import KLPerturbRole, RRLabelRole, MixupRole
from .role import MixMatchRole
    ...
    def surrogate_top(self, input_shape, device):
        ...
        if len(input_shape) == 1:
            ...
            sub_model.add_module('dense1', nn.Linear(np.prod(input_shape),
                                                     4096))
            sub_model.add_module('dense2', nn.Linear(4096, 1024))
            sub_model.add_module('dense3', nn.Linear(1024, self.n_class))
