...
from .role import KLPerturbRole, RRLabelRole
from .entry import Entry
from torch import optim, nn

class SplitHist(SplitModel):
    def __init__(self, in_channels, inter_view, n_class, defense=None, defense_args=None):
        super(SplitHist, self).__init__()

        self.defense = defense
        self.defense_args = defense_args

        # layer 1
        self.layers.append([nn.Conv2d(in_channels, 64, kernel_size=5, padding=1)])

        # layer 2
        self.layers.append([nn.Conv2d(64, 64, kernel_size=3, stride=2, padding=1)])
        ...
        # layer 5
        self.layers.append([nn.Conv2d(64, 128, kernel_size=5, padding=1)])
        ...
        # layer 9
        self.layers.append([nn.Conv2d(128, 256, kernel_size=5, padding=1)])
