...
save_pathes = ['output/fashion-mnist-mc-ldp-defense-simplenet.pickle',
               'output/cifar10-mc-ldp-defense-simplenet.pickle',
               'output/dogs-vs-cats-mc-ldp-defense-simplenet.pickle',
               'output/hist-mc-ldp-defense-simplenet.pickle',
               'output/intel-mc-ldp-defense-simplenet.pickle',
               'output/fruits-mc-ldp-defense-simplenet.pickle',
               'output/imagenet-mc-ldp-defense-simplenet.pickle',]
