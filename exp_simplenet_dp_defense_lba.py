...
skip_datasets = ['fashion-mnist', 'intel_classification', 'image-net', 'hist_cancer_detection']
save_pathes = ['output/fashion-mnist-lba-dp-defense-simplenet.pickle',
               'output/cifar10-mc-lba-defense-simplenet.pickle',
               'output/dogs-vs-cats-lba-dp-defense-simplenet.pickle',
               'output/hist-lba-dp-defense-simplenet.pickle',
               'output/intel-lba-dp-defense-simplenet.pickle',
               'output/fruits-lba-dp-defense-simplenet.pickle',
               'output/imagenet-lba-dp-defense-simplenet.pickle',]
