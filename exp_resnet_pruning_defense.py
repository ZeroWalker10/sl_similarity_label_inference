...
skip_datasets = []
save_pathes = ['output/fashion-mnist-pruning-defense-resnet18.pickle',
               'output/cifar10-pruning-defense-resnet18.pickle',
               'output/dogs-vs-cats-pruning-defense-resnet18.pickle',
               'output/hist-pruning-defense-resnet18.pickle',
               'output/intel-pruning-defense-resnet18.pickle',
               'output/flowers-pruning-defense-resnet18.pickle',
               'output/caltech256-pruning-defense-resnet18.pickle',
               'output/imagenet-pruning-defense-resnet18.pickle',]
