...
save_pathes = ['output/fashion-mnist-grads-attack-simplenet.pickle',
               'output/cifar10-grads-attack-simplenet.pickle',
               'output/dogs-vs-cats-grads-attack-simplenet.pickle',
               'output/hist-grads-attack-simplenet.pickle',
               'output/intel-grads-attack-simplenet.pickle',
               'output/fruits-grads-attack-simplenet.pickle',
               'output/imagenet-grads-attack-simplenet.pickle',]
