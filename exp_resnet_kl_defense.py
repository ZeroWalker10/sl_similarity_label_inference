...
skip_datasets = ['fashion-mnist', 'cifar10',
                 'hist_cancer_detection', 'caltech256',
                 '102flowers',
                 'intel_classification', 'image-net']
save_pathes = ['output/fashion-mnist-kl-defense-resnet18.pickle',
               'output/cifar10-kl-defense-resnet18.pickle',
               'output/dogs-vs-cats-kl-defense-resnet18.pickle',
               'output/hist-kl-defense-resnet18.pickle',
               'output/intel-kl-defense-resnet18.pickle',
               'output/flowers-kl-defense-resnet18.pickle',
               'output/caltech256-kl-defense-resnet18.pickle',
               'output/imagenet-kl-defense-resnet18.pickle',]
