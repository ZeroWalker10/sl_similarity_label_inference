...
save_pathes = ['output/fashion-mnist-ldp-defense-simplenet.pickle',
               'output/cifar10-ldp-defense-simplenet.pickle',
               'output/dogs-vs-cats-ldp-defense-simplenet.pickle',
               'output/hist-ldp-defense-simplenet.pickle',
               'output/intel-ldp-defense-simplenet.pickle',
               'output/fruits-ldp-defense-simplenet.pickle',
               'output/imagenet-ldp-defense-simplenet.pickle',]
