...
save_pathes = ['output/fashion-mnist-lba-pruning-defense-simplenet.pickle',
               'output/cifar10-lba-pruning-defense-simplenet.pickle',
               'output/dogs-vs-cats-lba-pruning-defense-simplenet.pickle',
               'output/hist-lba-pruning-defense-simplenet.pickle',
               'output/intel-lba-pruning-defense-simplenet.pickle',
               'output/fruits-lba-pruning-defense-simplenet.pickle',
               'output/imagenet-lba-pruning-defense-simplenet.pickle',]
