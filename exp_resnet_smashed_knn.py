...
save_pathes = ['output/fashion-mnist-smashed-knn-attack-resnet18.pickle',
               'output/cifar10-smashed-knn-attack-resnet18.pickle',
               'output/dogs-vs-cats-smashed-knn-attack-resnet18.pickle',
               'output/hist-smashed-knn-attack-resnet18.pickle',
               'output/intel-smashed-knn-attack-resnet18.pickle',
               'output/flowers-smashed-knn-attack-resnet18.pickle',
               'output/caltech256-smashed-knn-attack-resnet18.pickle',
               'output/imagenet-smashed-knn-attack-resnet18.pickle',]
