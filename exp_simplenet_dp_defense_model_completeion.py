...
save_pathes = ['output/fashion-mnist-mc-dp-defense-simplenet.pickle',
               'output/cifar10-mc-dp-defense-simplenet.pickle',
               'output/dogs-vs-cats-mc-dp-defense-simplenet.pickle',
               'output/hist-mc-dp-defense-simplenet.pickle',
               'output/intel-mc-dp-defense-simplenet.pickle',
               'output/fruits-mc-dp-defense-simplenet.pickle',
               'output/imagenet-mc-dp-defense-simplenet.pickle',]
