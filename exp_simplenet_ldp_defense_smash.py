...
save_pathes = ['output/fashion-mnist-smash-ldp-defense-simplenet.pickle',
               'output/cifar10-smash-ldp-defense-simplenet.pickle',
               'output/dogs-vs-cats-smash-ldp-defense-simplenet.pickle',
               'output/hist-smash-ldp-defense-simplenet.pickle',
               'output/intel-smash-ldp-defense-simplenet.pickle',
               'output/fruits-smash-ldp-defense-simplenet.pickle',
               'output/imagenet-smash-ldp-defense-simplenet.pickle',]
...
for (n_epoch, lr, batch_size, data_path, dataset, composer, save_path, metric) in \
    ...
    for epsilon in epsilons:
        ...
        training_loop(n_epoch, total_pipeline,
                      train_loader, device, mixup_alpha=mixup_alpha)
