...
skip_datasets = ['fashion-mnist', 
                 ...
                 'cifar10']
save_pathes = ['output/fashion-mnist-knn-attack-resnet18.pickle',
               'output/cifar10-knn-attack-resnet18.pickle',
               'output/dogs-vs-cats-knn-attack-resnet18.pickle',
               'output/hist-knn-attack-resnet18.pickle',
               'output/intel-knn-attack-resnet18.pickle',
               'output/fruits-knn-attack-resnet18.pickle',
               'output/imagenet-knn-attack-resnet18.pickle',]
