...
save_pathes = ['output/fashion-mnist-mc-kl-defense-simplenet.pickle',
               'output/cifar10-mc-kl-defense-simplenet.pickle',
               'output/dogs-vs-cats-mc-kl-defense-simplenet.pickle',
               'output/hist-mc-kl-defense-simplenet.pickle',
               'output/intel-mc-kl-defense-simplenet.pickle',
               'output/fruits-mc-kl-defense-simplenet.pickle',
               'output/imagenet-mc-kl-defense-simplenet.pickle',]
