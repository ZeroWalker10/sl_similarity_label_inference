...
save_pathes = ['output/fashion-mnist-knn-dp-defense-simplenet.pickle',
               'output/cifar10-knn-dp-defense-simplenet.pickle',
               'output/dogs-vs-cats-knn-dp-defense-simplenet.pickle',
               'output/hist-knn-dp-defense-simplenet.pickle',
               'output/intel-knn-dp-defense-simplenet.pickle',
               'output/fruits-knn-dp-defense-simplenet.pickle',
               'output/imagenet-knn-dp-defense-simplenet.pickle',]
