...
skip_datasets = []
save_pathes = ['output/fashion-mnist-smashed-attack-resnet18.pickle',
               'output/cifar10-smashed-attack-resnet18.pickle',
               'output/dogs-vs-cats-smashed-attack-resnet18.pickle',
               'output/hist-smashed-attack-resnet18.pickle',
               'output/intel-smashed-attack-resnet18.pickle',
               'output/flowers-smashed-attack-resnet18.pickle',
               'output/caltech256-smashed-attack-resnet18.pickle',
               'output/imagenet-smashed-attack-resnet18.pickle',]
