...
skip_datasets = ['imagenet']
save_pathes = ['output/fashion-mnist-knn-attack-simplenet.pickle',
               'output/cifar10-knn-attack-simplenet.pickle',
               'output/dogs-vs-cats-knn-attack-simplenet.pickle',
               'output/hist-knn-attack-simplenet.pickle',
               'output/intel-knn-attack-simplenet.pickle',
               'output/flowers-knn-attack-simplenet.pickle',
               'output/fruits-knn-attack-simplenet.pickle',
               'output/imagenet-knn-attack-simplenet.pickle',]
