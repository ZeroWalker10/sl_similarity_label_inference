...
save_pathes = ['output/fashion-mnist-pruning-defense-simplenet.pickle',
               'output/cifar10-pruning-defense-simplenet.pickle',
               'output/dogs-vs-cats-pruning-defense-simplenet.pickle',
               'output/hist-pruning-defense-simplenet.pickle',
               'output/intel-pruning-defense-simplenet.pickle',
               'output/fruits-pruning-defense-simplenet.pickle',
               'output/imagenet-pruning-defense-simplenet.pickle',]
